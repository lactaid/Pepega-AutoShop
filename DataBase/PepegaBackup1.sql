...
INSERT INTO `departamento` VALUES (1,1),(2,1),(3,1),(4,1),(5,1),(6,5),(7,5),(8,5),(9,5),(10,5),(11,10),(12,10),(13,10),(14,10),(15,10),(16,15),(17,15),(18,15),(19,15),(20,15),(21,20),(22,20),(23,20),(24,20),(25,20);
...
CREATE TABLE `diagnostico` (
  ...
  PRIMARY KEY (`Placa`),
  KEY `TrabajoDiagnostico_idx` (`idTrabajo`),
  CONSTRAINT `TrabajoDiagnostico` FOREIGN KEY (`idTrabajo`) REFERENCES `trabajo` (`idTrabajo`)
...
INSERT INTO `diagnostico` VALUES ('ABC1234',1,'El motor presenta un ruido extraño y falta de potencia'),('BCD8901',2,'Los frenos están desgastados y producen chirridos al frenar'),('CDE4567',3,'Las llantas presentan desgaste irregular y falta de alineación'),('DEF5678',4,'La transmisión tiene dificultades para cambiar de marcha'),('EFG2345',5,'El aceite del motor muestra signos de contaminación'),('EFG8901',6,'La batería no retiene carga adecuadamente'),('GHI9012',7,'Se presentan fallos eléctricos en diferentes sistemas del vehículo'),('HIJ2345',8,'El vehículo experimenta fallas intermitentes y pérdida de potencia'),('HIJ6789',9,'La suspensión está desgastada y produce ruidos al pasar por baches'),('JKL3456',10,'Las llantas presentan desgaste excesivo en los bordes'),('KLM0123',11,'Se observan fugas en el sistema de escape'),('KLM6789',12,'El filtro de aire está obstruido y requiere reemplazo'),('MNO7890',13,'La dirección del vehículo es difícil de maniobrar'),('NOP0123',14,'Las bujías están desgastadas y no generan chispa adecuada'),('NOP4567',15,'El sistema de frenos muestra desgaste en las pastillas y pérdida de eficiencia'),('PQR2345',16,'La correa de distribución está desgastada y presenta grietas'),('QRS4567',17,'El sistema de climatización no enfría correctamente'),('QRS8901',18,'Los amortiguadores presentan fugas y pérdida de efectividad'),('STU6789',19,'El sistema de dirección asistida tiene dificultades al girar'),('TUV2345',20,'El sensor de oxígeno muestra señales irregulares'),('TUV8901',21,'La suspensión neumática presenta fugas de aire y no se ajusta correctamente'),('VWX0123',22,'El filtro de combustible está obstruido y reduce el flujo de combustible'),('WXY6789',23,'El sistema de inyección de combustible presenta fallos y consumo excesivo'),('YZA4567',24,'La bomba de agua tiene fugas y debe ser reemplazada'),('ZAB0123',25,'El sistema de dirección hidráulica presenta pérdida de líquido y dificultades al girar');
...
INSERT INTO `trabajo` VALUES (1,'ABC1234','50.00',NULL,1,1),(2,'DEF5678','75.00',NULL,2,5),(3,'GHI9012','60.00',NULL,3,15),(4,'JKL3456','120.00',NULL,4,10),(5,'MNO7890','90.00',NULL,5,20),(6,'PQR2345','80.00',NULL,6,1),(7,'STU6789','100.00',NULL,7,10),(8,'VWX0123','70.00',NULL,8,5),(9,'YZA4567','110.00',NULL,9,15),(10,'BCD8901','95.00',NULL,10,1),(11,'EFG2345','85.00',NULL,11,20),(12,'HIJ6789','150.00',NULL,12,5),(13,'KLM0123','55.00',NULL,13,10),(14,'NOP4567','125.00',NULL,14,15),(15,'QRS8901','70.00',NULL,15,20),(16,'TUV2345','90.00',NULL,16,1),(17,'WXY6789','120.00',NULL,17,10),(18,'ZAB0123','80.00',NULL,18,5),(19,'CDE4567','100.00',NULL,19,15),(20,'EFG8901','75.00',NULL,20,20),(21,'HIJ2345','65.00',NULL,21,1),(22,'KLM6789','130.00',NULL,22,10),(23,'NOP0123','95.00',NULL,23,5),(24,'QRS4567','115.00',NULL,24,15),(25,'TUV8901','85.00',NULL,25,20);
...
-- Dump completed on 2023-05-24 21:48:23
